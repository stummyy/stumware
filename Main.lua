...
local Maid = loadstring(game:HttpGet('https://raw.githubusercontent.com/stummyy/stumware/main/Maid.lua'))()
local Signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/stummyy/stumware/main/Signal.lua'))()
